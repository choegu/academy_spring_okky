...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			...
			<ul class="navbar-nav ml-auto">
				<li class="nav-item">
					<a class="nav-link" href="study_room.jsp">
					<i class="fa fa-fw fa-book"></i>STUDY ROOM</a></li>
				<li class="nav-item"><a class="nav-link" href="community.jsp">
				<i class="fa fa-fw fa-comments-o"></i>COMMUNITY</a></li>
	...
	<div class="content-wrapper">
		...
		<div id="target">
		<!-- 첫화면 -->
			<iframe src="commMain.do" id="the_iframe" width="100%"
