	...
	<div class="container-fluid">
		<div class="card mb-3">
			<div class="card-header">
				<i class="fa fa-check"></i> 아이디 찾기 완료
			</div>
			<div class="card-body">
				<div align="center">
					<table>
						...
						<tr>
							<td>
								가입한 ID <input type="text" class="form-control1"value="${searchId}" readonly="readonly">
							</td>
						</tr>
						<tr>
							<td>
			...
			<div class="card-footer small text-muted">Id Search Success</div>
		</div>
	</div>
</body>
</html>