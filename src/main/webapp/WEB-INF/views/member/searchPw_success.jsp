	...
	<div class="container-fluid">
		<div class="card mb-3">
			<div class="card-header">
				<i class="fa fa-check"></i> 비밀번호 찾기 완료
			</div>
			<div class="card-body">
				<div align="center">
					<table>
						...
						<tr>
							<td>
								가입한 PW <input type="text" class="form-control1"value="${searchPw}" readonly="readonly">
							</td>
						</tr>
						<tr>
							<td>
			...
			<div class="card-footer small text-muted">Pw Search Success</div>
		</div>
	</div>
</body>
</html>